...
int main() {
    ...
    // Wyświetlanie tego, co znajduje sie w obu obszarach pamieci
    printf("Obszar 1:\n");
    for (int i = 0; i < n; i++) {
        printf("%d ", *(obsz1 + i));
    }
...
/* po sprawdzeniu - Prawidłowe formatowanie, weryfikacja wprowadzonej liczby, weryfikacji wyniku
funkcji malloc. Tylko to rzutowanie! De facto podwójne! Z double na long double
(realnie to ten sam typ), a potem do int. Tak się nie robi :-) */
